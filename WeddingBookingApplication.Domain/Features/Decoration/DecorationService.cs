...
public class DecorationService
{
    ...
    {
        List<DecorationResponseModel> packages = _db.DecorationPackages
            .Where(p => p.IsActive)
    ...
    {
        var package = _db.DecorationPackages.FirstOrDefault(p => p.DecorationPackageId == id);
    ...
    public DecorationCreateResponseModel CreateDecorationPackage(DecorationCreateRequestModel request)
    {
        try
        {
            var package = new DecorationPackage
            {
            ...
            _db.DecorationPackages.Add(package);
    ...
    // ── Mapping helper ──────────────────────────────────────────────────────────
    private static DecorationResponseModel MapToResponse(DecorationPackage p)
    {
