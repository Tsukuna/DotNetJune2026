...
public class VendorService
{
    ...
    {
        var vendor = _db.Vendors.FirstOrDefault(v => v.VendorId == id);
    ...
    public VendorCreateResponseModel CreateVendor(VendorCreateRequestModel request)
    {
        try
        {
            var vendor = new Database.AppDbContextModels.Vendor
            {
    ...
    // ── Mapping helper ──────────────────────────────────────────────────────────
    private static VendorResponseModel MapToResponse(Database.AppDbContextModels.Vendor v)
    {
