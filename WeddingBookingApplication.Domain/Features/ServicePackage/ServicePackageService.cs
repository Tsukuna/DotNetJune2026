...
public class ServicePackageService
{
    ...
    {
        var packages = _db.ServicePackages
            .Where(p => p.IsActive)
    ...
    {
        var package = _db.ServicePackages.FirstOrDefault(p => p.ServicePackageId == id);
    ...
    public ServiceCreateResponseModel CreateServicePackage(ServiceCreateRequestModel request)
    {
        try
        {
            var package = new Database.AppDbContextModels.ServicePackage
            {
    ...
    // ── Mapping helper ──────────────────────────────────────────────────────────
    private static ServiceResponseModel MapToResponse(Database.AppDbContextModels.ServicePackage p)
    {
